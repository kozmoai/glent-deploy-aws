...
import { DynamoDBConstruct, NetworkConstruct, KOZMOEnvironmentParams } from "@aws/aws-app-development-common-constructs";
...
export interface KOZMOGenAIEnvStackProps extends cdk.StackProps {
  uniqueEnvIdentifier: string;
}

export class KOZMOGenAIEnvStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: KOZMOGenAIEnvStackProps) {
