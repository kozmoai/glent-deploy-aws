...
import { KOZMOGenAIEnvStack } from "./kozmo-gen-ai-environment-stack";
...
async function main() {
  ...
  new KOZMOGenAIEnvStack(app, `GEN-AI-ENV-${process.env.ENV_NAME}-Stack`, {
    ...
    description: `${envID} Gen AI Environment for KOZMO(AWS App Development)`,
