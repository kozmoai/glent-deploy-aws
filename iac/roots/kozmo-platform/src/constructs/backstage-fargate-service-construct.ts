...
export interface BackstageFargateServiceConstructProps extends StackProps {
  ...
  /**
   * The KOZMO infrastructure configuration
   */
...
export class BackstageFargateServiceConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: BackstageFargateServiceConstructProps) {
    ...
    const backstageSecret = new Secret(this, `${props.kozmoEnv.prefix}-backstage-appsecret`, {
      secretName: `${props.kozmoEnv.prefix}-backstage-appsecret`,
    });
      ...
      `${props.kozmoEnv.prefix}-backstage`,
      {
        ...
        taskImageOptions: {
          ...
          environment: {
            ...
            BACKSTAGE_TITLE: "KOZMO",
            BACKSTAGE_ORGNAME: "KOZMO",
            PROTOCOL: "https",
