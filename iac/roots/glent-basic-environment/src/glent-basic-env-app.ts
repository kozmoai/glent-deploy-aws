...
import { GLENTBasicEnvStack } from "./glent-basic-environment-stack";
...
async function main() {
  ...
  // scope: Construct, id: string, props: GLENTBasicEnvStackProps
  new GLENTBasicEnvStack(app, `BASIC-ENV-${process.env.ENV_NAME}-Stack`, {
    // stackName: `glent-basic-environment`,  // Do not use stack name to get a generated stack name so multiple stacks can be created
    description: `${envID} Basic Environment for GLENT(AWS App Development)`,
