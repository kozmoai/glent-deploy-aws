...
export interface ServerlessAPIProvisioningConstructProps extends cdk.StackProps {
...
const defaultProps: Partial<ServerlessAPIProvisioningConstructProps> = {};

export class ServerlessAPIProvisioningConstruct extends Construct {
  ...
  constructor(parent: Construct, name: string, props: ServerlessAPIProvisioningConstructProps) {
    super(parent, name);
