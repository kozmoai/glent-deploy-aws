...
export enum EKS_OPTIONAL_ENV_VARS {
  ...
  CREATE_K8S_GLENT_RESOURCES = "CREATE_K8S_GLENT_RESOURCES"
}
...
export function getPrefix(): string {
  return process.env[EKS_ENV_VARS.PREFIX] as string || "glent";
}
...
export function getCreateK8sGlentResources(): boolean {
  const strVal = process.env[EKS_OPTIONAL_ENV_VARS.CREATE_K8S_GLENT_RESOURCES] as string;
