...
import { GLENTEKSEnvStack } from "./glent-eks-environment-stack";
import {
  getAccountId, 
  getRegion, 
  getPrefix, 
...
async function main() {
  ...
  new GLENTEKSEnvStack(app, `EKS-ENV-${getPrefix()}-${getEnvironmentName()}-Stack`, {
    description: `${envID} EKS Environment for GLENT`,
