...
export interface GLENTEKSManagedNodeClusterFluentBitConstructProps extends cdk.StackProps {
...
export class GLENTEKSManagedNodeClusterFluentBitConstruct extends Construct {

  constructor(parent: Construct, name: string, props: GLENTEKSManagedNodeClusterFluentBitConstructProps) {
    super(parent, name);
    ...
    const fluentBitSARole = new EKSFluentBitRoleConstruct(
      ...
      {
        awsAccount: props.glentEnv.awsAccount,
    ...
    const fluentBitClusterInfoConfigMap = {
      ...
      data: {
        ...
        'read.head': 'Off',
        'read.tail': 'On',
        'logs.region': `${props.glentEnv.awsRegion}`,
      },
    };
