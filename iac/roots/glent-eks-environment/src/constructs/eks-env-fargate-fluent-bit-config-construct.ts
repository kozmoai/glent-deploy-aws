...
export interface GLENTEKSFargateClusterFluentBitConstructProps extends cdk.StackProps {
  readonly glentEnv: GLENTEnvironmentParams;

  cluster: eks.Cluster
}

export class GLENTEKSFargateClusterFluentBitConstruct extends Construct {

  constructor(parent: Construct, name: string, props: GLENTEKSFargateClusterFluentBitConstructProps) {
    super(parent, name);
