...
import { GLENTEKSFargateClusterFluentBitConstruct } from "./eks-env-fargate-fluent-bit-config-construct";

// This class creates an EKS Cluster that uses Fargate

export interface GLENTEKSFargateClusterConstructProps extends cdk.StackProps {
...
export class GLENTEKSFargateClusterConstruct extends Construct {
  public readonly cluster: eks.Cluster

  constructor(parent: Construct, name: string, props: GLENTEKSFargateClusterConstructProps) {
    super(parent, name);
    ...
    new GLENTEKSFargateClusterFluentBitConstruct(this, `${envIdentifier}-fluent-bit-config`, {
