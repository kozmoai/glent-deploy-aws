...
import { GLENTEKSManagedNodeClusterFluentBitConstruct } from "./eks-env-managed-node-fluent-bit-config-construct";
import {
  getAmiType,
  getInstanceType,
...
export interface GLENTEKSManagedNodeClusterConstructProps extends cdk.StackProps {
...
export class GLENTEKSManagedNodeClusterConstruct extends Construct {
  public readonly cluster: eks.Cluster

  constructor(parent: Construct, name: string, props: GLENTEKSManagedNodeClusterConstructProps) {
    super(parent, name);
    ...
    new GLENTEKSManagedNodeClusterFluentBitConstruct(this, `${envIdentifier}-fluent-bit-config`, {
