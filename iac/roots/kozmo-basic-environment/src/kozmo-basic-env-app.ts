...
import { KOZMOBasicEnvStack } from "./kozmo-basic-environment-stack";
...
async function main() {
  ...
  // scope: Construct, id: string, props: KOZMOBasicEnvStackProps
  new KOZMOBasicEnvStack(app, `BASIC-ENV-${process.env.ENV_NAME}-Stack`, {
    // stackName: `kozmo-basic-environment`,  // Do not use stack name to get a generated stack name so multiple stacks can be created
    description: `${envID} Basic Environment for KOZMO(AWS App Development)`,
