...
export interface GenAIProvisioningConstructProps extends cdk.StackProps {
...
const defaultProps: Partial<GenAIProvisioningConstructProps> = {};

export class GenAIProvisioningConstruct extends Construct {
  ...
  constructor(parent: Construct, name: string, props: GenAIProvisioningConstructProps) {
    super(parent, name);
