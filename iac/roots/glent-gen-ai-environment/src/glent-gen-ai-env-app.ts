...
import { GLENTGenAIEnvStack } from "./glent-gen-ai-environment-stack";
...
async function main() {
  ...
  new GLENTGenAIEnvStack(app, `GEN-AI-ENV-${process.env.ENV_NAME}-Stack`, {
    ...
    description: `${envID} Gen AI Environment for GLENT(AWS App Development)`,
