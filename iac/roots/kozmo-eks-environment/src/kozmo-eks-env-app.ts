...
import { KOZMOEKSEnvStack } from "./kozmo-eks-environment-stack";
import {
  getAccountId, 
  getRegion, 
  getPrefix, 
...
async function main() {
  ...
  new KOZMOEKSEnvStack(app, `EKS-ENV-${getPrefix()}-${getEnvironmentName()}-Stack`, {
    description: `${envID} EKS Environment for KOZMO`,
