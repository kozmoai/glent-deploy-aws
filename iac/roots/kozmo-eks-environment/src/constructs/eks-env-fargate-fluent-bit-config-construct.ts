...
export interface KOZMOEKSFargateClusterFluentBitConstructProps extends cdk.StackProps {
  readonly kozmoEnv: KOZMOEnvironmentParams;

  cluster: eks.Cluster
}

export class KOZMOEKSFargateClusterFluentBitConstruct extends Construct {

  constructor(parent: Construct, name: string, props: KOZMOEKSFargateClusterFluentBitConstructProps) {
    super(parent, name);
