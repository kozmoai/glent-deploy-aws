...
export interface KOZMOEKSManagedNodeClusterFluentBitConstructProps extends cdk.StackProps {
...
export class KOZMOEKSManagedNodeClusterFluentBitConstruct extends Construct {

  constructor(parent: Construct, name: string, props: KOZMOEKSManagedNodeClusterFluentBitConstructProps) {
    super(parent, name);
    ...
    const fluentBitSARole = new EKSFluentBitRoleConstruct(
      ...
      {
        awsAccount: props.kozmoEnv.awsAccount,
    ...
    const fluentBitClusterInfoConfigMap = {
      ...
      data: {
        ...
        'read.head': 'Off',
        'read.tail': 'On',
        'logs.region': `${props.kozmoEnv.awsRegion}`,
      },
    };
