...
import { KOZMOEKSManagedNodeClusterFluentBitConstruct } from "./eks-env-managed-node-fluent-bit-config-construct";
import {
  getAmiType,
  getInstanceType,
...
export interface KOZMOEKSManagedNodeClusterConstructProps extends cdk.StackProps {
...
export class KOZMOEKSManagedNodeClusterConstruct extends Construct {
  public readonly cluster: eks.Cluster

  constructor(parent: Construct, name: string, props: KOZMOEKSManagedNodeClusterConstructProps) {
    super(parent, name);
    ...
    new KOZMOEKSManagedNodeClusterFluentBitConstruct(this, `${envIdentifier}-fluent-bit-config`, {
