...
import { KOZMOEKSFargateClusterFluentBitConstruct } from "./eks-env-fargate-fluent-bit-config-construct";

// This class creates an EKS Cluster that uses Fargate

export interface KOZMOEKSFargateClusterConstructProps extends cdk.StackProps {
...
export class KOZMOEKSFargateClusterConstruct extends Construct {
  public readonly cluster: eks.Cluster

  constructor(parent: Construct, name: string, props: KOZMOEKSFargateClusterConstructProps) {
    super(parent, name);
    ...
    new KOZMOEKSFargateClusterFluentBitConstruct(this, `${envIdentifier}-fluent-bit-config`, {
