...
export enum EKS_OPTIONAL_ENV_VARS {
  ...
  CREATE_K8S_KOZMO_RESOURCES = "CREATE_K8S_KOZMO_RESOURCES"
}
...
export function getPrefix(): string {
  return process.env[EKS_ENV_VARS.PREFIX] as string || "kozmo";
}
...
export function getCreateK8sKozmoResources(): boolean {
  const strVal = process.env[EKS_OPTIONAL_ENV_VARS.CREATE_K8S_KOZMO_RESOURCES] as string;
