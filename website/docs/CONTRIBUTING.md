...
See the [LICENSE](https://github.com/kozmoai/kozmo-deploy-aws/blob/main/LICENSE) file for our project's licensing. We will ask you to confirm the licensing of your contribution.


## Contributing Assets to KOZMO on AWS

Thank you for considering a contribution to KOZMO on AWS project!
...
1. Contributing KOZMO on AWS Templates
   1. Provider Template
   2. App Template
   3. Resource Template
   4. Other Template
2. Contributing KOZMO on AWS Pipelines
   1. New pipeline pattern
   2. Update existing pipeline pattern
3. Contributing KOZMO on AWS Core modifications
   1. Change in UI / Frontend of KOZMO on AWS plugins
   2. Change in SDK API / Backend of KOZMO on AWS Plugins
   3. Change in sacffolder actions
   4. Change in architecture or platform design
   5. Change in common interfaces
4. Contributing KOZMO on AWS extensions
   1. Integration with new tools and plugins
   2. Integration with additional Backstage.io APIs / entities
   3. Extending KOZMO on AWS model

### Submitting Contribution

Before submitting any contribution type please make sure it adheres to the KOZMO on AWS [architecture](https://kozmoonaws.io/docs/techdocs/architecture)

### Contributing an KOZMO on AWS provider
...
We highly recommend to test different context for this step as described in the [test-cases](https://kozmoonaws.io/docs/tests)

**Step 2**<br/>
Make sure you can update the provider configurations or IAC and the pipeline will apply the changes succufully 

**Step 3**<br/>
Add entries in  [test-cases](https://kozmoonaws.io/docs/tests) document for the new provider implemented.

#### Submit your PR
Submit a pull request for the new provider following the instructions in this page.


### Contributing an KOZMO on AWS application
...
3. Does this application can use an existing environment or it requires a new environment type / provider? if so, see the above *Contributing an KOZMO on AWS provider*
...
**Step 3**<br/>
Add entries in  [test-cases](https://kozmoonaws.io/docs/tests) document for the new application implemented.
